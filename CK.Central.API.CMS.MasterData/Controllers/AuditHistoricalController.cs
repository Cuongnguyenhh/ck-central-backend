...
namespace CK.Central.API.CMS.MasterData.Controllers
{
    ...
    public class AuditHistoricalController : ControllerEntityBase<AuditHistoricalEntity>
    {
        private readonly IAuditHistoricalRepository _repository;
        private readonly ILogger<AuditHistoricalController> _logger;
        ...
        public AuditHistoricalController(ILogger<AuditHistoricalController> logger, IAuditHistoricalRepository repository,
