...
{
    public class CampaignItemConfiguration : IEntityTypeConfiguration<CampaignItemEntity>
    {
        public void Configure(EntityTypeBuilder<CampaignItemEntity> builder)
        {
            builder.ToTable("campaign_item");
