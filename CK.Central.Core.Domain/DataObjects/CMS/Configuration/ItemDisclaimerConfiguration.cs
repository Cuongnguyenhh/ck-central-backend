...
{
    public class ItemDisclaimerConfiguration : IEntityTypeConfiguration<ItemDisclaimerEntity>
    {
        public void Configure(EntityTypeBuilder<ItemDisclaimerEntity> builder)
        {
            builder.ToTable("item_disclaimer");
