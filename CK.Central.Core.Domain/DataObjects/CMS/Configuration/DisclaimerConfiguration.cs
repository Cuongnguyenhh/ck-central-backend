...
{
    public class DisclaimerConfiguration : IEntityTypeConfiguration<DisclaimerEntity>
    {
        public void Configure(EntityTypeBuilder<DisclaimerEntity> builder)
        {
            builder.ToTable("disclaimer");
