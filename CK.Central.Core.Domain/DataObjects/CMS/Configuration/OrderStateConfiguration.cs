...
{
    public class OrderStateConfiguration : IEntityTypeConfiguration<OrderStateEntity>
    {
        public void Configure(EntityTypeBuilder<OrderStateEntity> builder)
        {
            builder.ToTable("order_state");
