...
{
    public class AuditHistoricalConfiguration : IEntityTypeConfiguration<AuditHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<AuditHistoricalEntity> builder)
        {
            builder.ToTable("audit_historical");
