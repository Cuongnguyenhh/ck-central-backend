...
{
    public class ReportTemplateConfiguration : IEntityTypeConfiguration<ReportTemplateEntity>
    {
        public void Configure(EntityTypeBuilder<ReportTemplateEntity> builder)
        {
