...
{
    public class GenerationPipelineConfiguration : IEntityTypeConfiguration<GenerationPipelineEntity>
    {
        public void Configure(EntityTypeBuilder<GenerationPipelineEntity> builder)
        {
            builder.ToTable("generation_pipeline");
