...
{
    public class GenerationActivityConfiguration : IEntityTypeConfiguration<GenerationActivityEntity>
    {
        public void Configure(EntityTypeBuilder<GenerationActivityEntity> builder)
        {
            builder.ToTable("generation_activity");
