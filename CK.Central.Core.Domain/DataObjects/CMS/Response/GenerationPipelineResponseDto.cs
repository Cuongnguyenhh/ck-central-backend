...
{
    public class GenerationPipelineResponseDto : BaseResponseDto
    {
        public GenerationPipelineResponseDto() { }
        public GenerationPipelineResponseDto(GenerationPipelineEntity entity)
        {
