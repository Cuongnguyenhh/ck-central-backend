...
{
    public class AuditHistoricalResponseDto : BaseResponseDto
    {
        public AuditHistoricalResponseDto() { }
        public AuditHistoricalResponseDto(AuditHistoricalEntity entity)
        {
