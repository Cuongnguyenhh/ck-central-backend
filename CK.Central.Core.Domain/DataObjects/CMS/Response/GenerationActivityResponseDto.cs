...
{
    public class GenerationActivityResponseDto : BaseResponseDto
    {
        public GenerationActivityResponseDto() { }
        public GenerationActivityResponseDto(GenerationActivityEntity entity)
        {
