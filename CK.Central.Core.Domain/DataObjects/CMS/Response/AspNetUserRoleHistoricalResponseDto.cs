...
{
    public class AspNetUserRoleHistoricalResponseDto : BaseResponseDto
    {
        public AspNetUserRoleHistoricalResponseDto() { }
        public AspNetUserRoleHistoricalResponseDto(AspNetUserRoleHistoricalEntity entity)
        {
