...
{
    public class GenerationHistoricalResponseDto : BaseResponseDto
    {
        public GenerationHistoricalResponseDto() { }
        public GenerationHistoricalResponseDto(GenerationHistoricalEntity entity)
        {
