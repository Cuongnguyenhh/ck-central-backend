...
{
    public class AspNetUserLoginHistoricalResponseDto : BaseResponseDto
    {
        public AspNetUserLoginHistoricalResponseDto() { }
        public AspNetUserLoginHistoricalResponseDto(AspNetUserLoginHistoricalEntity entity)
        {
