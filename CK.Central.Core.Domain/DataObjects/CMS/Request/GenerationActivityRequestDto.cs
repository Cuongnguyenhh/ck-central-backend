...
{
    public class GenerationActivityRequestDto : BaseRequestDto
    {
        public GenerationActivityRequestDto() { }
        public GenerationActivityRequestDto(GenerationActivityEntity entity)
        {
