...
{
    public class GenerationPipelineRequestDto : BaseRequestDto
    {
        public GenerationPipelineRequestDto() { }
        public GenerationPipelineRequestDto(GenerationPipelineEntity entity)
        {
