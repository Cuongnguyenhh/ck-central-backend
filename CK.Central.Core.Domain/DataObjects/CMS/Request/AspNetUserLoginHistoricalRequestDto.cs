...
{
    public class AspNetUserLoginHistoricalRequestDto : BaseRequestDto
    {
        public AspNetUserLoginHistoricalRequestDto() { }
        public AspNetUserLoginHistoricalRequestDto(AspNetUserLoginHistoricalEntity entity)
        {
