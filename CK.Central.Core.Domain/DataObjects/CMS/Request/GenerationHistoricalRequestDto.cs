...
{
    public class GenerationHistoricalRequestDto : BaseRequestDto
    {
        public GenerationHistoricalRequestDto() { }
        public GenerationHistoricalRequestDto(GenerationHistoricalEntity entity)
        {
