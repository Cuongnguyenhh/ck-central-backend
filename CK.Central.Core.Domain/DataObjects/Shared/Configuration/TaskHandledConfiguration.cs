...
{
    public class TaskHandledConfiguration : IEntityTypeConfiguration<TaskHandledEntity>
    {
        public void Configure(EntityTypeBuilder<TaskHandledEntity> builder)
        {
            builder.ToTable("task_handled");
