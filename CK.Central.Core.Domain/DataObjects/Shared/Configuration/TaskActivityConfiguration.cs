...
{
    public class TaskActivityConfiguration : IEntityTypeConfiguration<TaskActivityEntity>
    {
        public void Configure(EntityTypeBuilder<TaskActivityEntity> builder)
        {
            builder.ToTable("task_activity");
