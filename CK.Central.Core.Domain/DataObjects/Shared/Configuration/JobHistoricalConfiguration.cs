...
{
    public class JobHistoricalConfiguration : IEntityTypeConfiguration<JobHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<JobHistoricalEntity> builder)
        {
            builder.ToTable("job_historical");
