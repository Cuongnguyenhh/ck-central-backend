...
{
    public class JobActivityConfiguration : IEntityTypeConfiguration<JobActivityEntity>
    {
        public void Configure(EntityTypeBuilder<JobActivityEntity> builder)
        {
            builder.ToTable("job_activity");
