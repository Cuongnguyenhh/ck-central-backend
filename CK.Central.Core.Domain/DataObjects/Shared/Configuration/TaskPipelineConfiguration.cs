...
{
    public class TaskPipelineConfiguration : IEntityTypeConfiguration<TaskPipelineEntity>
    {
        public void Configure(EntityTypeBuilder<TaskPipelineEntity> builder)
        {
            builder.ToTable("task_pipeline");
