...
{
    public class HealthcheckPipelineConfiguration : IEntityTypeConfiguration<HealthcheckPipelineEntity>
    {
        public void Configure(EntityTypeBuilder<HealthcheckPipelineEntity> builder)
        {
            builder.ToTable("healthcheck_pipeline");
