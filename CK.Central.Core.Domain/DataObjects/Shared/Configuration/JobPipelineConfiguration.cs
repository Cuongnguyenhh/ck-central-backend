...
{
    public class JobPipelineConfiguration : IEntityTypeConfiguration<JobPipelineEntity>
    {
        public void Configure(EntityTypeBuilder<JobPipelineEntity> builder)
        {
            builder.ToTable("job_pipeline");
