...
{
    public class GeneralHistoricalConfiguration : IEntityTypeConfiguration<GeneralHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<GeneralHistoricalEntity> builder)
        {
            builder.ToTable("general_historical");
