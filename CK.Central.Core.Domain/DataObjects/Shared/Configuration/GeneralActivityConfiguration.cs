...
{
    public class GeneralActivityConfiguration : IEntityTypeConfiguration<GeneralActivityEntity>
    {
        public void Configure(EntityTypeBuilder<GeneralActivityEntity> builder)
        {
            builder.ToTable("general_activity");
