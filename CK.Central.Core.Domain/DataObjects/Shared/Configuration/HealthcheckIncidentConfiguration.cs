...
{
    public class HealthcheckIncidentConfiguration : IEntityTypeConfiguration<HealthcheckIncidentEntity>
    {
        public void Configure(EntityTypeBuilder<HealthcheckIncidentEntity> builder)
        {
            builder.ToTable("healthcheck_incident");
