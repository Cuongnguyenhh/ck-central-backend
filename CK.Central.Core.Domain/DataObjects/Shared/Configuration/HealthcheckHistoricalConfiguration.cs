...
{
    public class HealthcheckHistoricalConfiguration : IEntityTypeConfiguration<HealthcheckHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<HealthcheckHistoricalEntity> builder)
        {
            builder.ToTable("healthcheck_historical");
