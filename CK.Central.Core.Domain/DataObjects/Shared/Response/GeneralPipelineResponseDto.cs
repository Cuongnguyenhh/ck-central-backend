...
{
    public class GeneralPipelineResponseDto : BaseResponseDto
    {
        public GeneralPipelineResponseDto() { }
        public GeneralPipelineResponseDto(GeneralPipelineEntity entity)
        {
