...
{
    public class HealthcheckActivityResponseDto : BaseResponseDto
    {
        public HealthcheckActivityResponseDto() { }
        public HealthcheckActivityResponseDto(HealthcheckActivityEntity entity)
        {
