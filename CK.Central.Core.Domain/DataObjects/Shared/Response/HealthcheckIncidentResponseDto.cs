...
{
    public class HealthcheckIncidentResponseDto : BaseResponseDto
    {
        public HealthcheckIncidentResponseDto() { }
        public HealthcheckIncidentResponseDto(HealthcheckIncidentEntity entity)
        {
