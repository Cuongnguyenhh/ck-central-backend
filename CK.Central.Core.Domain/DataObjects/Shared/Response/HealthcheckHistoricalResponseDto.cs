...
{
    public class HealthcheckHistoricalResponseDto : BaseResponseDto
    {
        public HealthcheckHistoricalResponseDto() { }
        public HealthcheckHistoricalResponseDto(HealthcheckHistoricalEntity entity)
        {
