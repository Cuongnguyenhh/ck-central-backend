...
{
    public class GeneralActivityResponseDto : BaseResponseDto
    {
        public GeneralActivityResponseDto() { }
        public GeneralActivityResponseDto(GeneralActivityEntity entity)
        {
