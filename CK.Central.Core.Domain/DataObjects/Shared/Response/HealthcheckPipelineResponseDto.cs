...
{
    public class HealthcheckPipelineResponseDto : BaseResponseDto
    {
        public HealthcheckPipelineResponseDto() { }
        public HealthcheckPipelineResponseDto(HealthcheckPipelineEntity entity)
        {
