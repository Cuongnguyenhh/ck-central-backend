...
{
    public class OrderHistoricalResponseDto : BaseResponseDto
    {
        public OrderHistoricalResponseDto() { }
        public OrderHistoricalResponseDto(OrderHistoricalEntity entity)
        {
