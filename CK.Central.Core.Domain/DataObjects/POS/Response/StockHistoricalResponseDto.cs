...
{
    public class StockHistoricalResponseDto : BaseResponseDto
    {
        public StockHistoricalResponseDto() { }
        public StockHistoricalResponseDto(StockHistoricalEntity entity)
        {
