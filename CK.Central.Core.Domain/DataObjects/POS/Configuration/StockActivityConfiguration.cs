...
{
    public class StockActivityConfiguration : IEntityTypeConfiguration<StockActivityEntity>
    {
        public void Configure(EntityTypeBuilder<StockActivityEntity> builder)
        {
            builder.ToTable("stock_activity");
