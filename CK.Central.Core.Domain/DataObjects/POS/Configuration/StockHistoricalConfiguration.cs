...
{
    public class StockHistoricalConfiguration : IEntityTypeConfiguration<StockHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<StockHistoricalEntity> builder)
        {
            builder.ToTable("stock_historical");
