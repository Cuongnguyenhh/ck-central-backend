...
{
    public class OrderInvoiceConfiguration : IEntityTypeConfiguration<OrderInvoiceEntity>
    {
        public void Configure(EntityTypeBuilder<OrderInvoiceEntity> builder)
        {
            builder.ToTable("order_invoice");
