...
{
    public class OrderCustomerConfiguration : IEntityTypeConfiguration<OrderCustomerEntity>
    {
        public void Configure(EntityTypeBuilder<OrderCustomerEntity> builder)
        {
            builder.ToTable("order_customer");
