...
{
    public class OrderCancelConfiguration : IEntityTypeConfiguration<OrderCancelEntity>
    {
        public void Configure(EntityTypeBuilder<OrderCancelEntity> builder)
        {
            builder.ToTable("order_cancel");
