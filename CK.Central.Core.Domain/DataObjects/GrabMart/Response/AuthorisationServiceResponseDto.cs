...
{
    public class AuthorisationServiceResponseDto : BaseResponseDto
    {
        public AuthorisationServiceResponseDto() { }
        public AuthorisationServiceResponseDto(AuthorisationServiceEntity entity)
        {
