...
{
    public class OrderReadyResponseDto : BaseResponseDto
    {
        public OrderReadyResponseDto() { }
        public OrderReadyResponseDto(OrderReadyEntity entity)
        {
    ...
    public class UpdateNewReadyTimeResponseDto()
    {
        public string? target { get; set; }
        public string? reason { get; set; }
        public string? message { get; set; }
