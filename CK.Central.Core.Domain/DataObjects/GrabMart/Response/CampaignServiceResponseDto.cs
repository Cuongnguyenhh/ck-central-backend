...
{
    public class CampaignServiceResponseDto : BaseResponseDto
    {
        public CampaignServiceResponseDto() { }
        public CampaignServiceResponseDto(CampaignServiceEntity entity)
        {
