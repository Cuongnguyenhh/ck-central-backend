...
{
    public class OrderItemModifierResponseDto : BaseResponseDto
    {
        public OrderItemModifierResponseDto() { }
        public OrderItemModifierResponseDto(OrderItemModifierEntity entity)
        {
