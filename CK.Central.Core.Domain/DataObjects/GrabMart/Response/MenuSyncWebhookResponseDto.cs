...
{
    public class MenuSyncWebhookResponseDto : BaseResponseDto
    {
        public MenuSyncWebhookResponseDto() { }
        public MenuSyncWebhookResponseDto(MenuSyncWebhookEntity entity)
        {
    ...
    public class PartnerMenuSyncWebhookResponseDto
    {
