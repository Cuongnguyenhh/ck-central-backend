...
{
    public class StoreDeliveryHoursResponseDto : BaseResponseDto
    {
        public StoreDeliveryHoursResponseDto() { }
        public StoreDeliveryHoursResponseDto(StoreDeliveryHoursEntity entity)
        {
    ...
    public class UpdateDeliveryHoursResponseDto
    {
        public string? errorReasons { get; set; }
        public int? orderCount { get; set; }
        public int? scheduledOrderCount { get; set; }
