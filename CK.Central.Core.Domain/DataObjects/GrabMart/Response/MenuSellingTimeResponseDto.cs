...
{
    public class MenuSellingTimeResponseDto : BaseResponseDto
    {
        public MenuSellingTimeResponseDto() { }
        public MenuSellingTimeResponseDto(MenuSellingTimeEntity entity)
        {
