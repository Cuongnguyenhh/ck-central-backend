...
{
    public class AuthorisationActivityResponseDto : BaseResponseDto
    {
        public AuthorisationActivityResponseDto() { }
        public AuthorisationActivityResponseDto(AuthorisationActivityEntity entity)
        {
