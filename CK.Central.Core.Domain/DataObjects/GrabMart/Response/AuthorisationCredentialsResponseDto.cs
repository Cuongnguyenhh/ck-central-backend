...
{
    public class AuthorisationCredentialsResponseDto : BaseResponseDto
    {
        public AuthorisationCredentialsResponseDto() { }
        public AuthorisationCredentialsResponseDto(AuthorisationCredentialsEntity entity)
        {
