...
{
    public class AuthorisationHistoricalResponseDto : BaseResponseDto
    {
        public AuthorisationHistoricalResponseDto() { }
        public AuthorisationHistoricalResponseDto(AuthorisationHistoricalEntity entity)
        {
