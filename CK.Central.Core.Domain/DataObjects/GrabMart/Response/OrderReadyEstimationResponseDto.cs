...
{
    public class OrderReadyEstimationResponseDto : BaseResponseDto
    {
        public OrderReadyEstimationResponseDto() { }
        public OrderReadyEstimationResponseDto(OrderReadyEstimationEntity entity)
        {
