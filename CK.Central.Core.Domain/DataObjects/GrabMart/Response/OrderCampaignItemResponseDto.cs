...
{
    public class OrderCampaignItemResponseDto : BaseResponseDto
    {
        public OrderCampaignItemResponseDto() { }
        public OrderCampaignItemResponseDto(OrderCampaignItemEntity entity)
        {
