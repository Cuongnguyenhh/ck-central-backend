...
{
    public class CampaignOngoingResponseDto : BaseResponseDto
    {
        public CampaignOngoingResponseDto() { }
        public CampaignOngoingResponseDto(CampaignOngoingEntity entity)
        {
