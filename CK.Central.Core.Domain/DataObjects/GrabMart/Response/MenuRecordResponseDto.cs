...
{
    public class MenuRecordResponseDto : BaseResponseDto
    {
        public MenuRecordResponseDto() { }
        public MenuRecordResponseDto(MenuRecordEntity entity)
        {
    ...
    public class UpdateMenuRecordResponseDto
    {
