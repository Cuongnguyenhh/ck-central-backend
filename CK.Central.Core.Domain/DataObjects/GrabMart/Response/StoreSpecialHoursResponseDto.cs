...
{
    public class StoreSpecialHoursResponseDto : BaseResponseDto
    {
        public StoreSpecialHoursResponseDto() { }
        public StoreSpecialHoursResponseDto(StoreSpecialHoursEntity entity)
        {
    ...
    public class UpdateSpecialHoursResponseDto
    {
