...
{
    public class CampaignHistoricalResponseDto : BaseResponseDto
    {
        public CampaignHistoricalResponseDto() { }
        public CampaignHistoricalResponseDto(CampaignHistoricalEntity entity)
        {
