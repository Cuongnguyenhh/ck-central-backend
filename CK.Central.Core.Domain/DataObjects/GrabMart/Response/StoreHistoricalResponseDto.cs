...
{
    public class StoreHistoricalResponseDto : BaseResponseDto
    {
        public StoreHistoricalResponseDto() { }
        public StoreHistoricalResponseDto(StoreHistoricalEntity entity)
        {
