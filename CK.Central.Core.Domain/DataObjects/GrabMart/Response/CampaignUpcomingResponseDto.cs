...
{
    public class CampaignUpcomingResponseDto : BaseResponseDto
    {
        public CampaignUpcomingResponseDto() { }
        public CampaignUpcomingResponseDto(CampaignUpcomingEntity entity)
        {
