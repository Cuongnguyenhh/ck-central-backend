...
{
    public class StorePauseResponseDto : BaseResponseDto
    {
        public StorePauseResponseDto() { }
        public StorePauseResponseDto(StorePauseEntity entity)
        {
    ...
    public class TemporarilyPauseStoreResponseDto
    {
