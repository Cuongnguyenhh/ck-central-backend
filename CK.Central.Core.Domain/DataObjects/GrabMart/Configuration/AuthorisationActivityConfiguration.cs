...
{
    public class AuthorisationActivityConfiguration : IEntityTypeConfiguration<AuthorisationActivityEntity>
    {
        public void Configure(EntityTypeBuilder<AuthorisationActivityEntity> builder)
        {
            builder.ToTable("authorisation_activity");
