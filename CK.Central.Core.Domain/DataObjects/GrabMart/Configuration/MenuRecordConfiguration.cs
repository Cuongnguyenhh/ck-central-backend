...
{
    public class MenuRecordConfiguration : IEntityTypeConfiguration<MenuRecordEntity>
    {
        public void Configure(EntityTypeBuilder<MenuRecordEntity> builder)
        {
            builder.ToTable("menu_record");
