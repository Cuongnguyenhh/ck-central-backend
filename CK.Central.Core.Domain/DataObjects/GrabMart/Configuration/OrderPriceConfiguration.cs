...
{
    public class OrderPriceConfiguration : IEntityTypeConfiguration<OrderPriceEntity>
    {
        public void Configure(EntityTypeBuilder<OrderPriceEntity> builder)
        {
            builder.ToTable("order_price");
