...
{
    public class CampaignServiceConfiguration : IEntityTypeConfiguration<CampaignServiceEntity>
    {
        public void Configure(EntityTypeBuilder<CampaignServiceEntity> builder)
        {
