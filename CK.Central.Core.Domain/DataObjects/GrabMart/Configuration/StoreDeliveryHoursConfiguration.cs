...
{
    public class StoreDeliveryHoursConfiguration : IEntityTypeConfiguration<StoreDeliveryHoursEntity>
    {
        public void Configure(EntityTypeBuilder<StoreDeliveryHoursEntity> builder)
        {
            builder.ToTable("store_delivery_hours");
