...
{
    public class MenuServiceConfiguration : IEntityTypeConfiguration<MenuServiceEntity>
    {
        public void Configure(EntityTypeBuilder<MenuServiceEntity> builder)
        {
            builder.ToTable("menu_service");
