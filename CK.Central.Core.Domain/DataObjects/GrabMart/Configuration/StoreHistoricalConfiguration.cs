...
{
    public class StoreHistoricalConfiguration : IEntityTypeConfiguration<StoreHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<StoreHistoricalEntity> builder)
        {
            builder.ToTable("store_historical");
