...
{
    public class StoreStatusConfiguration : IEntityTypeConfiguration<StoreStatusEntity>
    {
        public void Configure(EntityTypeBuilder<StoreStatusEntity> builder)
        {
            builder.ToTable("store_status");
