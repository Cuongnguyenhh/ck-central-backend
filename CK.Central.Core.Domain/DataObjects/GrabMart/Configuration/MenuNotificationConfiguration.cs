...
{
    public class MenuNotificationConfiguration : IEntityTypeConfiguration<MenuNotificationEntity>
    {
        public void Configure(EntityTypeBuilder<MenuNotificationEntity> builder)
        {
            builder.ToTable("menu_notification");
