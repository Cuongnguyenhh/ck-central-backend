...
{
    public class StoreActivityConfiguration : IEntityTypeConfiguration<StoreActivityEntity>
    {
        public void Configure(EntityTypeBuilder<StoreActivityEntity> builder)
        {
            builder.ToTable("store_activity");
