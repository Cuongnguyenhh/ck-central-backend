...
{
    public class OrderCampaignConfiguration : IEntityTypeConfiguration<OrderCampaignEntity>
    {
        public void Configure(EntityTypeBuilder<OrderCampaignEntity> builder)
        {
            builder.ToTable("order_campaign");
