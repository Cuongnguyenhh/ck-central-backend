...
{
    public class OrderReadyEstimationConfiguration : IEntityTypeConfiguration<OrderReadyEstimationEntity>
    {
        public void Configure(EntityTypeBuilder<OrderReadyEstimationEntity> builder)
        {
            builder.ToTable("order_ready_estimation");
