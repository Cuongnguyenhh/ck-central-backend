...
{
    public class MenuMartConfiguration : IEntityTypeConfiguration<MenuMartEntity>
    {
        public void Configure(EntityTypeBuilder<MenuMartEntity> builder)
        {
            builder.ToTable("menu_mart");
