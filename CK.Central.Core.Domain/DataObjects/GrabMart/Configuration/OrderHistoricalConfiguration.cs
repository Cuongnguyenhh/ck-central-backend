...
{
    public class OrderHistoricalConfiguration : IEntityTypeConfiguration<OrderHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<OrderHistoricalEntity> builder)
        {
            builder.ToTable("order_historical");
