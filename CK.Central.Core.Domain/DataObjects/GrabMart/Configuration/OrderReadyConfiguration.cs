...
{
    public class OrderReadyConfiguration : IEntityTypeConfiguration<OrderReadyEntity>
    {
        public void Configure(EntityTypeBuilder<OrderReadyEntity> builder)
        {
            builder.ToTable("order_ready");
