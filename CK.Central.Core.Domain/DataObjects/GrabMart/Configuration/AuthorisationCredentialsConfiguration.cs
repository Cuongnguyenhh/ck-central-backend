...
{
    public class AuthorisationCredentialsConfiguration : IEntityTypeConfiguration<AuthorisationCredentialsEntity>
    {
        public void Configure(EntityTypeBuilder<AuthorisationCredentialsEntity> builder)
        {
            builder.ToTable("authorisation_credentials");
