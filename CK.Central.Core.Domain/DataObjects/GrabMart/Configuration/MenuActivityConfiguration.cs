...
{
    public class MenuActivityConfiguration : IEntityTypeConfiguration<MenuActivityEntity>
    {
        public void Configure(EntityTypeBuilder<MenuActivityEntity> builder)
        {
            builder.ToTable("menu_activity");
