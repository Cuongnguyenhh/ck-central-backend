...
{
    public class StoreSpecialHoursConfiguration : IEntityTypeConfiguration<StoreSpecialHoursEntity>
    {
        public void Configure(EntityTypeBuilder<StoreSpecialHoursEntity> builder)
        {
            builder.ToTable("store_special_hours");
