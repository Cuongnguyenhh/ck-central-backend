...
{
    public class OrderReceiverConfiguration : IEntityTypeConfiguration<OrderReceiverEntity>
    {
        public void Configure(EntityTypeBuilder<OrderReceiverEntity> builder)
        {
            builder.ToTable("order_receiver");
