...
{
    public class MenuHistoricalConfiguration : IEntityTypeConfiguration<MenuHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<MenuHistoricalEntity> builder)
        {
            builder.ToTable("menu_historical");
