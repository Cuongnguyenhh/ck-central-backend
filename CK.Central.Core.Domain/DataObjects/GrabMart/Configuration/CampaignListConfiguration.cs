...
{
    public class CampaignListConfiguration : IEntityTypeConfiguration<CampaignListEntity>
    {
        public void Configure(EntityTypeBuilder<CampaignListEntity> builder)
        {
            builder.ToTable("campaign_list");
