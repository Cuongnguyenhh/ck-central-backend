...
{
    public class CampaignUpcomingConfiguration : IEntityTypeConfiguration<CampaignUpcomingEntity>
    {
        public void Configure(EntityTypeBuilder<CampaignUpcomingEntity> builder)
        {
            builder.ToTable("campaign_upcoming");
