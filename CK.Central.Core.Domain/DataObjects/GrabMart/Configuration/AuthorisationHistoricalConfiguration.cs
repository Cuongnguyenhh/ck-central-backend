...
{
    public class AuthorisationHistoricalConfiguration : IEntityTypeConfiguration<AuthorisationHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<AuthorisationHistoricalEntity> builder)
        {
            builder.ToTable("authorisation_historical");
