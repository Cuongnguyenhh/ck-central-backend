...
{
    public class CampaignHistoricalConfiguration : IEntityTypeConfiguration<CampaignHistoricalEntity>
    {
        public void Configure(EntityTypeBuilder<CampaignHistoricalEntity> builder)
        {
            builder.ToTable("campaign_historical");
