...
{
    public class AuthorisationServiceConfiguration : IEntityTypeConfiguration<AuthorisationServiceEntity>
    {
        public void Configure(EntityTypeBuilder<AuthorisationServiceEntity> builder)
        {
            builder.ToTable("authorisation_service");
