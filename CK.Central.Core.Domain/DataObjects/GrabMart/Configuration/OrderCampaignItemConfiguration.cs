...
{
    public class OrderCampaignItemConfiguration : IEntityTypeConfiguration<OrderCampaignItemEntity>
    {
        public void Configure(EntityTypeBuilder<OrderCampaignItemEntity> builder)
        {
            builder.ToTable("order_campaign_item");
