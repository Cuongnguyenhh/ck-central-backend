...
{
    public class CampaignOngoingConfiguration : IEntityTypeConfiguration<CampaignOngoingEntity>
    {
        public void Configure(EntityTypeBuilder<CampaignOngoingEntity> builder)
        {
            builder.ToTable("campaign_ongoing");
