...
{
    public class OrderCancelableConfiguration : IEntityTypeConfiguration<OrderCancelableEntity>
    {
        public void Configure(EntityTypeBuilder<OrderCancelableEntity> builder)
        {
            builder.ToTable("order_cancelable");
