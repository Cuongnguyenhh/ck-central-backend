...
{
    public class MenuCategoriesConfiguration : IEntityTypeConfiguration<MenuCategoriesEntity>
    {
        public void Configure(EntityTypeBuilder<MenuCategoriesEntity> builder)
        {
