...
{
    public class AuthorisationTokenConfiguration : IEntityTypeConfiguration<AuthorisationTokenEntity>
    {
        public void Configure(EntityTypeBuilder<AuthorisationTokenEntity> builder)
        {
            builder.ToTable("authorisation_token");
