...
{
    public class StorePauseConfiguration : IEntityTypeConfiguration<StorePauseEntity>
    {
        public void Configure(EntityTypeBuilder<StorePauseEntity> builder)
        {
            builder.ToTable("store_pause");
