...
{
    public class StoreServiceConfiguration : IEntityTypeConfiguration<StoreServiceEntity>
    {
        public void Configure(EntityTypeBuilder<StoreServiceEntity> builder)
        {
            builder.ToTable("store_service");
