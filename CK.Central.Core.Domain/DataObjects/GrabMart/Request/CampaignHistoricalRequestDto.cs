...
{
    public class CampaignHistoricalRequestDto : BaseRequestDto
    {
        public CampaignHistoricalRequestDto() { }
        public CampaignHistoricalRequestDto(CampaignHistoricalEntity entity)
        {
