...
{
    public class StoreHoursRequestDto : BaseRequestDto
    {
        public StoreHoursRequestDto() { }
        public StoreHoursRequestDto(StoreHoursEntity entity)
        {
    ...
    public class GetStoreHoursRequestDto
    {
