...
{
    public class CampaignListRequestDto : BaseRequestDto
    {
        public CampaignListRequestDto() { }
        public CampaignListRequestDto(CampaignListEntity entity)
        {
    ...
    public class ListCampaignsRequestDto
    {
