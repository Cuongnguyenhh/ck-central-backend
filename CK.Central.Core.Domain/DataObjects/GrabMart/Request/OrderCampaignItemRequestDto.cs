...
{
    public class OrderCampaignItemRequestDto : BaseRequestDto
    {
        public OrderCampaignItemRequestDto() { }
        public OrderCampaignItemRequestDto(OrderCampaignItemEntity entity)
        {
