...
{
    public class AuthorisationServiceRequestDto : BaseRequestDto
    {
        public AuthorisationServiceRequestDto() { }
        public AuthorisationServiceRequestDto(AuthorisationServiceEntity entity)
        {
