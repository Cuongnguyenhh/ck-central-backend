...
{
    public class MenuMartRequestDto : BaseRequestDto
    {
        public MenuMartRequestDto() { }
        public MenuMartRequestDto(MenuMartEntity entity)
        {
    ...
    public class PartnerMartMenuRequestDto
    {
