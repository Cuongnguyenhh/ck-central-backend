...
{
    public class OrderItemModifierRequestDto : BaseRequestDto
    {
        public OrderItemModifierRequestDto() { }
        public OrderItemModifierRequestDto(OrderItemModifierEntity entity)
        {
