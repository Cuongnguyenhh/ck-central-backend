...
{
    public class CampaignUpcomingRequestDto : BaseRequestDto
    {
        public CampaignUpcomingRequestDto() { }
        public CampaignUpcomingRequestDto(CampaignUpcomingEntity entity)
        {
