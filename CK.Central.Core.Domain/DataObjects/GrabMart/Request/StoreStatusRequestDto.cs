...
{
    public class StoreStatusRequestDto : BaseRequestDto
    {
        public StoreStatusRequestDto() { }
        public StoreStatusRequestDto(StoreStatusEntity entity)
        {
    ...
    public class GetStoreStatusRequestDto
    {
