...
{
    public class AuthorisationActivityRequestDto : BaseRequestDto
    {
        public AuthorisationActivityRequestDto() { }
        public AuthorisationActivityRequestDto(AuthorisationActivityEntity entity)
        {
