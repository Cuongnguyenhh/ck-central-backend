...
{
    public class StorePauseRequestDto : BaseRequestDto
    {
        public StorePauseRequestDto() { }
        public StorePauseRequestDto(StorePauseEntity entity)
        {
    ...
    public class TemporarilyPauseUnPauseRequestDto()
    {
