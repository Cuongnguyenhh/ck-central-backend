...
{
    public class OrderReadyEstimationRequestDto : BaseRequestDto
    {
        public OrderReadyEstimationRequestDto() { }
        public OrderReadyEstimationRequestDto(OrderReadyEstimationEntity entity)
        {
