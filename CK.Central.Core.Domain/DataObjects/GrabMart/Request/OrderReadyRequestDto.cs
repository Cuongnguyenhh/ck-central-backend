...
{
    public class OrderReadyRequestDto : BaseRequestDto
    {
        public OrderReadyRequestDto() { }
        public OrderReadyRequestDto(OrderReadyEntity entity)
        {
    ...
    public class MarkOrderAsReadyRequestDto()
    {
        public string? orderID { get; set; }
        public int? markStatus { get; set; }
    }

    public class UpdateNewReadyTimeRequestDto()
    {
