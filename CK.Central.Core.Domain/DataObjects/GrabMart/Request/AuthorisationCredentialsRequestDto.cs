...
{
    public class AuthorisationCredentialsRequestDto : BaseRequestDto
    {
        public AuthorisationCredentialsRequestDto() { }
        public AuthorisationCredentialsRequestDto(AuthorisationCredentialsEntity entity)
        {
