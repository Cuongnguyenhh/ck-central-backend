...
{
    public class AuthorisationHistoricalRequestDto : BaseRequestDto
    {
        public AuthorisationHistoricalRequestDto() { }
        public AuthorisationHistoricalRequestDto(AuthorisationHistoricalEntity entity)
        {
