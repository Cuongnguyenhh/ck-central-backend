...
{
    public class OrderUpdateRepository : BaseRepository<OrderUpdateEntity>, IOrderUpdateRepository
    {
        ...
        public OrderUpdateRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
