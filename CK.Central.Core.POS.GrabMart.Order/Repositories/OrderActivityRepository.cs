...
{
    public class OrderActivityRepository : BaseRepository<OrderActivityEntity>, IOrderActivityRepository
    {
        ...
        public OrderActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
