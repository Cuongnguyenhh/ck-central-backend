...
{
    public class OrderSubmitRepository : BaseRepository<OrderSubmitEntity>, IOrderSubmitRepository
    {
        ...
        public OrderSubmitRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
