...
{
    public class OrderCustomerRepository : BaseRepository<OrderCustomerEntity>, IOrderCustomerRepository
    {
        ...
        public OrderCustomerRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
