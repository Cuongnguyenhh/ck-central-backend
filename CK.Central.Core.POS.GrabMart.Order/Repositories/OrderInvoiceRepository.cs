...
{
    public class OrderInvoiceRepository : BaseRepository<OrderInvoiceEntity>, IOrderInvoiceRepository
    {
        ...
        public OrderInvoiceRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
