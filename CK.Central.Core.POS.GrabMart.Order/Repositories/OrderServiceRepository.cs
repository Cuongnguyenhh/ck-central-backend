...
{
    public class OrderServiceRepository : BaseRepository<OrderServiceEntity>, IOrderServiceRepository
    {
        ...
        public OrderServiceRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
