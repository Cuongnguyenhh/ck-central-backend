...
namespace CK.Central.API.CMS.Portal.Controllers
{
    ...
    public class CampaignController : ControllerEntityBase<CampaignEntity>
    {
        ...
        public CampaignController(ILogger<CampaignController> logger, ICampaignRepository repository,
