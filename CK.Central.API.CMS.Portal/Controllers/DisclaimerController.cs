...
namespace CK.Central.API.CMS.Portal.Controllers
{
    ...
    public class DisclaimerController : ControllerEntityBase<DisclaimerEntity>
    {
        private readonly IDisclaimerRepository _repository;
        ...
        public DisclaimerController(ILogger<DisclaimerController> logger, IDisclaimerRepository repository,
