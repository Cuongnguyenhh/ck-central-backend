...
namespace CK.Central.API.CMS.Portal.Controllers
{
    ...
    public class ReportTemplateController : ControllerEntityBase<ReportTemplateEntity>
    {
        ...
        public ReportTemplateController(ILogger<ReportTemplateController> logger, IReportTemplateRepository repository,
