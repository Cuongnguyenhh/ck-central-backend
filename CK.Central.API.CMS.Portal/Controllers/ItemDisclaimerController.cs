...
namespace CK.Central.API.CMS.Portal.Controllers
{
    ...
    public class ItemDisclaimerController : ControllerEntityBase<ItemDisclaimerEntity>
    {
        private readonly IItemDisclaimerRepository _repository;
        private readonly ILogger<ItemDisclaimerController> _logger;
        ...
        public ItemDisclaimerController(ILogger<ItemDisclaimerController> logger, 
            IItemDisclaimerRepository repository,
