...
{
    public class MenuRecordRepository : BaseRepository<MenuRecordEntity>, IMenuRecordRepository
    {
        ...
        public MenuRecordRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
