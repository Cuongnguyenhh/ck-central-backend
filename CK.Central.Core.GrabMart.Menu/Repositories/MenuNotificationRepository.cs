...
{
    public class MenuNotificationRepository : BaseRepository<MenuNotificationEntity>, IMenuNotificationRepository
    {
        ...
        public MenuNotificationRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
