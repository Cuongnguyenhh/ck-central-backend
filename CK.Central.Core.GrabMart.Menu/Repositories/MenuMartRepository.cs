...
{
    public class MenuMartRepository : BaseRepository<MenuMartEntity>, IMenuMartRepository
    {
        ...
        public MenuMartRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
