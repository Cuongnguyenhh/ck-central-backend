...
{
    public class MenuSyncWebhookRepository : BaseRepository<MenuSyncWebhookEntity>, IMenuSyncWebhookRepository
    {
        ...
        public MenuSyncWebhookRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
