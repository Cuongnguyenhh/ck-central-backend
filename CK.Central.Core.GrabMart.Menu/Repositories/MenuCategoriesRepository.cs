...
{
    public class MenuCategoriesRepository : BaseRepository<MenuCategoriesEntity>, IMenuCategoriesRepository
    {
        ...
        public MenuCategoriesRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
