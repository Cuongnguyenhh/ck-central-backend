...
{
    public class MenuActivityRepository : BaseRepository<MenuActivityEntity>, IMenuActivityRepository
    {
        ...
        public MenuActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
