...
{
    public class MenuSellingTimeRepository : BaseRepository<MenuSellingTimeEntity>, IMenuSellingTimeRepository
    {
        ...
        public MenuSellingTimeRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
