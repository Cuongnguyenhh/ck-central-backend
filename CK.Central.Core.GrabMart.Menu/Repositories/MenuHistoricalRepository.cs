...
{
    public class MenuHistoricalRepository : BaseRepository<MenuHistoricalEntity>, IMenuHistoricalRepository
    {
        ...
        public MenuHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
