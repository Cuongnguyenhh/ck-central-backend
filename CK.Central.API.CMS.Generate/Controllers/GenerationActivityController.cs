...
namespace CK.Central.API.CMS.Generate.Controllers
{
    ...
    public class GenerationActivityController : ControllerEntityBase<GenerationActivityEntity>
    {
        private readonly IGenerationActivityRepository _repository;
        private readonly ILogger<GenerationActivityController> _logger;
        ...
        public GenerationActivityController(ILogger<GenerationActivityController> logger,
            IGenerationActivityRepository repository,
