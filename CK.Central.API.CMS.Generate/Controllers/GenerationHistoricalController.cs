...
namespace CK.Central.API.CMS.Generate.Controllers
{
    ...
    public class GenerationHistoricalController : ControllerEntityBase<GenerationHistoricalEntity>
    {
        private readonly IGenerationHistoricalRepository _repository;
        private readonly ILogger<GenerationHistoricalController> _logger;
        ...
        public GenerationHistoricalController(ILogger<GenerationHistoricalController> logger,
            IGenerationHistoricalRepository repository,
            ...
            IRabbitMQProducerCMSGenerateService rabbitMQProducerService) : base(repository)
        {
            _logger = logger;
