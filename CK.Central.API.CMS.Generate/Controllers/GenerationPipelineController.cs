...
namespace CK.Central.API.CMS.Generate.Controllers
{
    ...
    public class GenerationPipelineController : ControllerEntityBase<GenerationPipelineEntity>
    {
        private readonly IGenerationPipelineRepository _repository;
        private readonly ILogger<GenerationPipelineController> _logger;
        ...
        public GenerationPipelineController(ILogger<GenerationPipelineController> logger,
            IGenerationPipelineRepository repository,
