...
namespace CK.Central.API.GrabMart.Job.Controllers
{
    ...
    public class JobActivityController : ControllerEntityBase<JobActivityEntity>
    {
        private readonly IJobActivityRepository _repository;
        private readonly ILogger<JobActivityController> _logger;
        ...
        public JobActivityController(ILogger<JobActivityController> logger,
            IJobActivityRepository repository,
