...
namespace CK.Central.API.GrabMart.Job.Controllers
{
    ...
    public class TaskActivityController : ControllerEntityBase<TaskActivityEntity>
    {
        private readonly ITaskActivityRepository _repository;
        private readonly ILogger<TaskActivityController> _logger;
        ...
        public TaskActivityController(ILogger<TaskActivityController> logger,
            ITaskActivityRepository repository,
