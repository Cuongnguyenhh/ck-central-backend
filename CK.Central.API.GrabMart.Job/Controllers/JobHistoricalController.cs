...
namespace CK.Central.API.GrabMart.Job.Controllers
{
    ...
    public class JobHistoricalController : ControllerEntityBase<JobHistoricalEntity>
    {
        private readonly IJobHistoricalRepository _repository;
        private readonly ILogger<JobHistoricalController> _logger;
        private readonly IElasticsearchGrabMartJobService _elasticsearchService;
        private readonly IRedisCacheGrabMartJobService _redisCacheService;
        ...
        public JobHistoricalController(ILogger<JobHistoricalController> logger,
            IJobHistoricalRepository repository,
            IElasticsearchGrabMartJobService elasticsearchService,
            IRedisCacheGrabMartJobService redisCacheService) : base(repository)
        {
            _logger = logger;
