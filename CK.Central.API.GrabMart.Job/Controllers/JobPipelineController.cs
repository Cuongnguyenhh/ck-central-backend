...
namespace CK.Central.API.GrabMart.Job.Controllers
{
    ...
    public class JobPipelineController : ControllerEntityBase<JobPipelineEntity>
    {
        private readonly IJobPipelineRepository _repository;
        private readonly ILogger<JobPipelineController> _logger;
        ...
        public JobPipelineController(ILogger<JobPipelineController> logger,
            IJobPipelineRepository repository,
