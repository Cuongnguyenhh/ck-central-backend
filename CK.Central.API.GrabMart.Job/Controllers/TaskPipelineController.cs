...
namespace CK.Central.API.GrabMart.Job.Controllers
{
    ...
    public class TaskPipelineController : ControllerEntityBase<TaskPipelineEntity>
    {
        private readonly ITaskPipelineRepository _repository;
        private readonly ILogger<TaskPipelineController> _logger;
        ...
        public TaskPipelineController(ILogger<TaskPipelineController> logger,
            ITaskPipelineRepository repository,
