...
namespace CK.Central.Core.GrabMart.Repositories
{
    public class GeneralActivityRepository : BaseRepository<GeneralActivityEntity>, IGeneralActivityRepository
    {
        ...
        public GeneralActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
