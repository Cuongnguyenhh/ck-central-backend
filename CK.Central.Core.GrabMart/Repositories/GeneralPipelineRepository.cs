...
{
    public class GeneralPipelineRepository : BaseRepository<GeneralPipelineEntity>, IGeneralPipelineRepository
    {
        ...
        public GeneralPipelineRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
