...
{
    public class GeneralCommandRepository : BaseRepository<GeneralCommandEntity>, IGeneralCommandRepository
    {
        ...
        public GeneralCommandRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
