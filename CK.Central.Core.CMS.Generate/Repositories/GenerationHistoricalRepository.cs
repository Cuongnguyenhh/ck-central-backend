...
{
    public class GenerationHistoricalRepository : BaseRepository<GenerationHistoricalEntity>, IGenerationHistoricalRepository
    {
        ...
        public GenerationHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
