...
{
    public class GenerationActivityRepository : BaseRepository<GenerationActivityEntity>, IGenerationActivityRepository
    {
        ...
        public GenerationActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
