...
{
    public class RabbitMQConsumerCMSGenerateService : RabbitMQConsumerBaseService, IRabbitMQConsumerCMSGenerateService
    {
        private readonly IRabbitMQBaseService _rabbitMQBaseService;

        public RabbitMQConsumerCMSGenerateService(IRabbitMQBaseService rabbitMqService) : base(rabbitMqService)
        {
