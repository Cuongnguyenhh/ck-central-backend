...
{
    public class DefinitionRepository : BaseRepository<DefinitionEntity>, IDefinitionRepository
    {
        ...
        public DefinitionRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
