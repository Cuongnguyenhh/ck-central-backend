...
{
    public class LanguageRepository : BaseRepository<LanguageEntity>, ILanguageRepository
    {
        ...
        public LanguageRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
