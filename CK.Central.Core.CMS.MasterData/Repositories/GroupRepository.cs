...
{
    public class GroupRepository : BaseRepository<GroupEntity>, IGroupRepository
    {
        ...
        public GroupRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
