...
namespace CK.Central.API.GrabMart.Menu.Controllers
{
    ...
    public class MenuRecordController : ControllerEntityBase<MenuRecordEntity>
    {
        private readonly IMediator _mediator;
        private readonly IMenuRecordRepository _repository;
        private readonly ILogger<MenuRecordController> _logger;
        ...
        public MenuRecordController(IMediator mediator,
            ILogger<MenuRecordController> logger, 
            IMenuRecordRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<UpdateMenuRecordResponseDto>> PartnerMenuNotificationAsync([FromBody] UpdateMenuRecordCommand command)
        {
            try
            {
