...
namespace CK.Central.API.GrabMart.Menu.Controllers
{
    ...
    public class MenuCategoriesController : ControllerEntityBase<MenuCategoriesEntity>
    {
        ...
        public MenuCategoriesController(IMediator mediator,
            ...
            IMenuCategoriesRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<ListMartCategoriesResponseDto>> PartnerMenuNotificationAsync([FromBody] ListMartCategoriesCommand command)
        {
            try
            {
