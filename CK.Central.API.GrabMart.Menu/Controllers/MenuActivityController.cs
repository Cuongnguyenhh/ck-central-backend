...
namespace CK.Central.API.GrabMart.Menu.Controllers
{
    ...
    public class MenuActivityController : ControllerEntityBase<MenuActivityEntity>
    {
        private readonly IMenuActivityRepository _repository;
        ...
        public MenuActivityController(ILogger<MenuActivityController> logger, 
            IMenuActivityRepository repository,
