...
namespace CK.Central.API.GrabMart.Menu.Controllers
{
    ...
    public class MenuMartController : ControllerEntityBase<MenuMartEntity>
    {
        private readonly IMediator _mediator;
        private readonly IMenuMartRepository _repository;
        private readonly ILogger<MenuMartController> _logger;
        ...
        public MenuMartController(IMediator mediator,
            ILogger<MenuMartController> logger, 
            IMenuMartRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<PartnerMartMenuResponseDto>> PartnerMartMenuAsync([FromBody] GetMartMenuCommand command)
        {
            try
            {
