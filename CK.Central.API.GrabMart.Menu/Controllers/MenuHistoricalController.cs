...
namespace CK.Central.API.GrabMart.Menu.Controllers
{
    ...
    public class MenuHistoricalController : ControllerEntityBase<MenuHistoricalEntity>
    {
        private readonly IMenuHistoricalRepository _repository;
        private readonly ILogger<MenuHistoricalController> _logger;
        ...
        public MenuHistoricalController(ILogger<MenuHistoricalController> logger, IMenuHistoricalRepository repository,
