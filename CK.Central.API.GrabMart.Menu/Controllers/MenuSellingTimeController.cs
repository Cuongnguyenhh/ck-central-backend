...
namespace CK.Central.API.GrabMart.Menu.Controllers
{
    ...
    public class MenuSellingTimeController : ControllerEntityBase<MenuSellingTimeEntity>
    {
        private readonly IMenuSellingTimeRepository _repository;
        private readonly ILogger<MenuSellingTimeController> _logger;
        ...
        public MenuSellingTimeController(ILogger<MenuSellingTimeController> logger, 
            IMenuSellingTimeRepository repository,
