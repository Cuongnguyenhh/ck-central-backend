...
namespace CK.Central.API.GrabMart.Menu.Controllers
{
    ...
    public class MenuNotificationController : ControllerEntityBase<MenuNotificationEntity>
    {
        private readonly IMediator _mediator;
        private readonly IMenuNotificationRepository _repository;
        private readonly ILogger<MenuNotificationController> _logger;
        ...
        public MenuNotificationController(
            IMediator mediator,
            ILogger<MenuNotificationController> logger, 
            IMenuNotificationRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<PartnerMenuNotificationResponseDto>> PartnerMenuNotificationAsync([FromBody] NotifyUpdatedMenuCommand command)
        {
            try
            {
