...
{
    public class AuthorisationHistoricalRepository : BaseRepository<AuthorisationHistoricalEntity>, IAuthorisationHistoricalRepository
    {
        ...
        public AuthorisationHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
