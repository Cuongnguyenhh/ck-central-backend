...
{
    public class AuthorisationServiceRepository : BaseRepository<AuthorisationServiceEntity>, IAuthorisationServiceRepository
    {
        ...
        public AuthorisationServiceRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
