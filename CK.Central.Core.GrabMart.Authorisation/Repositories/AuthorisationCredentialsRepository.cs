...
namespace CK.Central.Core.GrabMart.Authorisation.Repositories
{
    public class AuthorisationCredentialsRepository : BaseRepository<AuthorisationCredentialsEntity>, IAuthorisationCredentialsRepository
    {
        ...
        public AuthorisationCredentialsRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
