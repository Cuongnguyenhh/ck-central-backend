...
{
    public class AuthorisationActivityRepository : BaseRepository<AuthorisationActivityEntity>, IAuthorisationActivityRepository
    {
        ...
        public AuthorisationActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
