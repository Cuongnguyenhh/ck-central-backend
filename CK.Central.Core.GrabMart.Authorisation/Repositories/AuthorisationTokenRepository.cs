...
{
    public class AuthorisationTokenRepository : BaseRepository<AuthorisationTokenEntity>, IAuthorisationTokenRepository
    {
        ...
        public AuthorisationTokenRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
