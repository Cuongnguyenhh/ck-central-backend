...
namespace CK.Central.API.GrabMart.Campaign.Controllers
{
    ...
    public class CampaignUpcomingController : ControllerEntityBase<CampaignUpcomingEntity>
    {
        private readonly ICampaignUpcomingRepository _repository;
        private readonly ILogger<CampaignUpcomingController> _logger;
        ...
        public CampaignUpcomingController(ILogger<CampaignUpcomingController> logger, ICampaignUpcomingRepository repository,
