...
namespace CK.Central.API.GrabMart.Campaign.Controllers
{
    ...
    public class CampaignListController : ControllerEntityBase<CampaignListEntity>
    {
        private readonly ICampaignListRepository _repository;
        private readonly ILogger<CampaignListController> _logger;
        ...
        public CampaignListController(ILogger<CampaignListController> logger, ICampaignListRepository repository,
