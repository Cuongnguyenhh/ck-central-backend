...
namespace CK.Central.API.GrabMart.Campaign.Controllers
{
    ...
    public class CampaignOngoingController : ControllerEntityBase<CampaignOngoingEntity>
    {
        private readonly ICampaignOngoingRepository _repository;
        private readonly ILogger<CampaignOngoingController> _logger;
        ...
        public CampaignOngoingController(ILogger<CampaignOngoingController> logger, ICampaignOngoingRepository repository,
