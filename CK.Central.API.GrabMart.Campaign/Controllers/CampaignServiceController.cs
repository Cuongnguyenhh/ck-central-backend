...
namespace CK.Central.API.GrabMart.Campaign.Controllers
{
    ...
    public class CampaignServiceController : ControllerEntityBase<CampaignServiceEntity>
    {
        private readonly ICampaignServiceRepository _repository;
        private readonly ILogger<CampaignServiceController> _logger;
        ...
        public CampaignServiceController(ILogger<CampaignServiceController> logger, ICampaignServiceRepository repository,
