...
using CK.Central.Core.GrabMart.Campaign.Services;
...
namespace CK.Central.API.GrabMart.Campaign
{
    public static class InitialRegistration
    {
        public static IServiceCollection AddAuth(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CK.Central.API.GrabMart.Campaign", Version = "v1" });
        ...
        public static IServiceCollection AddDependencyInjection(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IElasticsearchGrabMartCampaignService, ElasticsearchGrabMartCampaignService>();
            services.AddScoped<IRedisCacheGrabMartCampaignService, RedisCacheGrabMartCampaignService>();
            services.AddScoped<IKafkaConsumerGrabMartCampaignService, KafkaConsumerGrabMartCampaignService>();
            services.AddScoped<IKafkaProducerGrabMartCampaignService, KafkaProducerGrabMartCampaignService>();
        ...
        (context, loggerConfiguration) =>
        {
            ...
            {
                loggerConfiguration.MinimumLevel.Override("CK-Central-GrabMart-Campaign", LogEventLevel.Debug);
            }
            ...
            if (!string.IsNullOrEmpty(elasticUrl))
            {
                loggerConfiguration.WriteTo.Elasticsearch(
                    new ElasticsearchSinkOptions(new Uri(elasticUrl))
                    {
                        ...
                        InlineFields = true,
                        IndexFormat = "CK-Central-GrabMart-Campaign-Logs-{0:yyyy.MM.dd}",
                        NumberOfReplicas = 2,
                        NumberOfShards = 2
                    });
            }
