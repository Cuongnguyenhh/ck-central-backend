...
{
    public class JobHistoricalRepository : BaseRepository<JobHistoricalEntity>, IJobHistoricalRepository
    {
        ...
        public JobHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
