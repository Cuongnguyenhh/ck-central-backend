...
{
    public class JobActivityRepository : BaseRepository<JobActivityEntity>, IJobActivityRepository
    {
        ...
        public JobActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
