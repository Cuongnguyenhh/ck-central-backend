...
{
    public class TaskPipelineRepository : BaseRepository<TaskPipelineEntity>, ITaskPipelineRepository
    {
        ...
        public TaskPipelineRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
