...
namespace CK.Central.Core.GrabMart.Job.Repositories
{
    public class TaskHistoricalRepository : BaseRepository<TaskHistoricalEntity>, ITaskHistoricalRepository
    {
        ...
        public TaskHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
