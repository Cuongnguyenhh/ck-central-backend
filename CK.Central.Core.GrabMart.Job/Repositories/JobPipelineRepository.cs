...
{
    public class JobPipelineRepository : BaseRepository<JobPipelineEntity>, IJobPipelineRepository
    {
        ...
        public JobPipelineRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
