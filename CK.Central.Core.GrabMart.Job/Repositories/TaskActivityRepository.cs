...
{
    public class TaskActivityRepository : BaseRepository<TaskActivityEntity>, ITaskActivityRepository
    {
        ...
        public TaskActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
