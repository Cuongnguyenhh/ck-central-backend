...
namespace CK.Central.API.GrabMart.Authorisation
{
    public static class InitialRegistration
    {
        public static IServiceCollection AddAuth(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CK.Central.API.GrabMart.Authorisation", Version = "v1" });
        ...
        public static IServiceCollection AddDependencyInjection(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IElasticsearchGrabMartAuthorisationService, ElasticsearchGrabMartAuthorisationService>();
            services.AddScoped<IRedisCacheGrabMartAuthorisationService, RedisCacheGrabMartAuthorisationService>();
            services.AddScoped<IKafkaConsumerGrabMartAuthorisationService, KafkaConsumerGrabMartAuthorisationService>();
            services.AddScoped<IKafkaProducerGrabMartAuthorisationService, KafkaProducerGrabMartAuthorisationService>();
        ...
        (context, loggerConfiguration) =>
        {
            ...
            {
                loggerConfiguration.MinimumLevel.Override("CK-Central-GrabMart-Authorisation", LogEventLevel.Debug);
            }
            ...
            if (!string.IsNullOrEmpty(elasticUrl))
            {
                loggerConfiguration.WriteTo.Elasticsearch(
                    new ElasticsearchSinkOptions(new Uri(elasticUrl))
                    {
                        ...
                        InlineFields = true,
                        IndexFormat = "CK-Central-GrabMart-Authorisation-Logs-{0:yyyy.MM.dd}",
                        NumberOfReplicas = 2,
                        NumberOfShards = 2
                    });
            }
