...
namespace CK.Central.API.GrabMart.Authorisation.Controllers
{
    ...
    public class AuthorisationServiceController : ControllerEntityBase<AuthorisationServiceEntity>
    {
        private readonly IAuthorisationServiceRepository _repository;
        private readonly ILogger<AuthorisationServiceController> _logger;
        ...
        public AuthorisationServiceController(ILogger<AuthorisationServiceController> logger, IAuthorisationServiceRepository repository,
