...
namespace CK.Central.API.GrabMart.Authorisation.Controllers
{
    ...
    public class AuthorisationHistoricalController : ControllerEntityBase<AuthorisationHistoricalEntity>
    {
        private readonly IAuthorisationHistoricalRepository _repository;
        private readonly ILogger<AuthorisationHistoricalController> _logger;
        ...
        public AuthorisationHistoricalController(ILogger<AuthorisationHistoricalController> logger, 
            IAuthorisationHistoricalRepository repository,
