...
namespace CK.Central.API.GrabMart.Authorisation.Controllers
{
    ...
    public class AuthorisationCredentialsController : ControllerEntityBase<AuthorisationCredentialsEntity>
    {
        private readonly IAuthorisationCredentialsRepository _repository;
        private readonly ILogger<AuthorisationCredentialsController> _logger;
        ...
        public AuthorisationCredentialsController(ILogger<AuthorisationCredentialsController> logger, 
            IAuthorisationCredentialsRepository repository,
