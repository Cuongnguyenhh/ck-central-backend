...
{
    public class IdentityUserLoginRepository : IIdentityUserLoginRepository
    {
        ...
        public IdentityUserLoginRepository(IMasterDbContext masterContext,
        ...
        public async Task<List<AspNetUserLoginEntity>> GetByUserId(string UserId)
        {
            return await _slaveDbContext.AspNetUserLogins.AsNoTracking().Where(x => x.UserId == UserId).ToListAsync();
        }
    }
}
