...
namespace CK.Central.API.GrabMart.Controllers
{
    ...
    public class GeneralCommandController : ControllerEntityBase<GeneralCommandEntity>
    {
        private readonly IGeneralCommandRepository _repository;
        private readonly ILogger<GeneralCommandController> _logger;
        ...
        public GeneralCommandController(ILogger<GeneralCommandController> logger,
            IGeneralCommandRepository repository,
