...
namespace CK.Central.API.GrabMart.Controllers
{
    ...
    public class GeneralActivityController : ControllerEntityBase<GeneralActivityEntity>
    {
        private readonly IGeneralActivityRepository _repository;
        private readonly ILogger<GeneralActivityController> _logger;
        ...
        public GeneralActivityController(ILogger<GeneralActivityController> logger,
            IGeneralActivityRepository repository,
            IElasticsearchGrabMartService elasticsearchService,
            IRedisCacheGrabMartService redisCacheService) : base(repository)
        {
            _logger = logger;
