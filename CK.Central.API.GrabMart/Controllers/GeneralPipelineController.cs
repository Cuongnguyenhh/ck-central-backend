...
namespace CK.Central.API.GrabMart.Controllers
{
    ...
    public class GeneralPipelineController : ControllerEntityBase<GeneralPipelineEntity>
    {
        private readonly IGeneralPipelineRepository _repository;
        private readonly ILogger<GeneralPipelineController> _logger;
        ...
        public GeneralPipelineController(ILogger<GeneralPipelineController> logger,
            IGeneralPipelineRepository repository,
