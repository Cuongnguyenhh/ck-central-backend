...
using CK.Central.Core.GrabMart.DbContexts;
using CK.Central.Core.Abstract.Repositories;
using CK.Central.Core.GrabMart.Abstract.Services;
using CK.Central.Core.GrabMart.Abstract.Repositories;
using CK.Central.Core.GrabMart.Services;
using CK.Central.Core.GrabMart.Repositories;
...
namespace CK.Central.API.GrabMart
{
    public static class InitialRegistration
    {
        public static IServiceCollection AddAuth(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CK.Central.API.GrabMart", Version = "v1" });
        ...
        public static IServiceCollection AddDependencyInjection(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IElasticsearchGrabMartService, ElasticsearchGrabMartService>();
            services.AddScoped<IRedisCacheGrabMartService, RedisCacheGrabMartService>();
            services.AddScoped<IKafkaConsumerGrabMartService, KafkaConsumerGrabMartService>();
            services.AddScoped<IKafkaProducerGrabMartService, KafkaProducerGrabMartService>();
        ...
        (context, loggerConfiguration) =>
        {
            ...
            {
                loggerConfiguration.MinimumLevel.Override("CK-Central-GrabMart", LogEventLevel.Debug);
            }
            ...
            if (!string.IsNullOrEmpty(elasticUrl))
            {
                loggerConfiguration.WriteTo.Elasticsearch(
                    new ElasticsearchSinkOptions(new Uri(elasticUrl))
                    {
                        ...
                        InlineFields = true,
                        IndexFormat = "CK-Central-GrabMart-Logs-{0:yyyy.MM.dd}",
                        NumberOfReplicas = 2,
                        NumberOfShards = 2
                    });
            }
