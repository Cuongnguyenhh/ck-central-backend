...
using CK.Central.Core.GrabMart.HealthCheck.Services;
using CK.Central.Core.GrabMart.HealthCheck.Repositories;
...
using CK.Central.Core.GrabMart.HealthCheck.Extensions;

namespace CK.Central.API.GrabMart.HealthCheck
{
    public static class InitialRegistration
    {
        public static IServiceCollection AddAuth(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CK.Central.API.GrabMart.HealthCheck", Version = "v1" });
        ...
        public static IServiceCollection AddDependencyInjection(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IElasticsearchGrabMartHealthCheckService, ElasticsearchGrabMartHealthCheckService>();
            services.AddScoped<IRedisCacheGrabMartHealthCheckService, RedisCacheGrabMartHealthCheckService>();
            services.AddScoped<IKafkaConsumerGrabMartHealthCheckService, KafkaConsumerGrabMartHealthCheckService>();
            services.AddScoped<IKafkaProducerGrabMartHealthCheckService, KafkaProducerGrabMartHealthCheckService>();
        ...
        public static IServiceCollection AddHealthCheck(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            //services.AddHealthChecks()
            //    .AddMongoDb(new ConnectionString(configuration.GetConnectionString("MasterPgsqlDbConnection")).ToString(), "");
        ...
        (context, loggerConfiguration) =>
        {
            ...
            {
                loggerConfiguration.MinimumLevel.Override("CK-Central-GrabMart-HealthCheck", LogEventLevel.Debug);
            }
            ...
            if (!string.IsNullOrEmpty(elasticUrl))
            {
                loggerConfiguration.WriteTo.Elasticsearch(
                    new ElasticsearchSinkOptions(new Uri(elasticUrl))
                    {
                        ...
                        InlineFields = true,
                        IndexFormat = "CK-Central-GrabMart-HealthCheck-Logs-{0:yyyy.MM.dd}",
                        NumberOfReplicas = 2,
                        NumberOfShards = 2
                    });
            }
