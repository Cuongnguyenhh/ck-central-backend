...
namespace CK.Central.API.GrabMart.HealthCheck.Controllers
{
    ...
    public class HealthcheckIncidentController : ControllerEntityBase<HealthcheckIncidentEntity>
    {
        private readonly IHealthcheckIncidentRepository _repository;
        private readonly ILogger<HealthcheckIncidentController> _logger;
        ...
        public HealthcheckIncidentController(ILogger<HealthcheckIncidentController> logger,
            IHealthcheckIncidentRepository repository,
