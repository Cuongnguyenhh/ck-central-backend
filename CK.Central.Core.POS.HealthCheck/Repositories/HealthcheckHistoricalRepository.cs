...
namespace CK.Central.Core.POS.HealthCheck.Repositories
{
    public class HealthcheckHistoricalRepository : BaseRepository<HealthcheckHistoricalEntity>, IHealthcheckHistoricalRepository
    {
        ...
        public HealthcheckHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
