...
{
    public class HealthcheckIncidentRepository : BaseRepository<HealthcheckIncidentEntity>, IHealthcheckIncidentRepository
    {
        ...
        public HealthcheckIncidentRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
