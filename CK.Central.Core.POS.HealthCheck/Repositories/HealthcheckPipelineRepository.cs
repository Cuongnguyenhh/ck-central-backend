...
{
    public class HealthcheckPipelineRepository : BaseRepository<HealthcheckPipelineEntity>, IHealthcheckPipelineRepository
    {
        ...
        public HealthcheckPipelineRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
