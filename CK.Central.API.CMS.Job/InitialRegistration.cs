...
using CK.Central.Core.CMS.Job.DbContexts;
using CK.Central.Core.CMS.Job.Services;
using CK.Central.Core.CMS.Job.Repositories;
...
namespace CK.Central.API.CMS.Job
{
    public static class InitialRegistration
    {
        public static IServiceCollection AddAuth(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CK.Central.API.CMS.Job", Version = "v1" });
        ...
        public static IServiceCollection AddDependencyInjection(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IElasticsearchCMSJobService, ElasticsearchCMSJobService>();
            services.AddScoped<IMemoryCacheCMSJobService, MemoryCacheCMSJobService>();
            services.AddScoped<IRedisCacheCMSJobService, RedisCacheCMSJobService>();
            services.AddScoped<IRabbitMQProducerCMSJobService, RabbitMQProducerCMSJobService>();
        ...
        (context, loggerConfiguration) =>
        {
            ...
            {
                loggerConfiguration.MinimumLevel.Override("CK-Central-CMS-Job", LogEventLevel.Debug);
            }
            ...
            if (!string.IsNullOrEmpty(elasticUrl))
            {
                loggerConfiguration.WriteTo.Elasticsearch(
                    new ElasticsearchSinkOptions(new Uri(elasticUrl))
                    {
                        ...
                        InlineFields = true,
                        IndexFormat = "CK-Central-CMS-Job-Logs-{0:yyyy.MM.dd}",
                        NumberOfReplicas = 2,
                        NumberOfShards = 2
                    });
            }
