...
namespace CK.Central.API.POS.GrabMart.Order.Controllers
{
    ...
    public class OrderInvoiceController : ControllerEntityBase<OrderInvoiceEntity>
    {
        private readonly IOrderInvoiceRepository _repository;
        private readonly ILogger<OrderInvoiceController> _logger;
        ...
        public OrderInvoiceController(ILogger<OrderInvoiceController> logger, IOrderInvoiceRepository repository,
