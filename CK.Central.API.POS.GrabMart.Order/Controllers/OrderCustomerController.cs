...
namespace CK.Central.API.POS.GrabMart.Order.Controllers
{
    ...
    public class OrderCustomerController : ControllerEntityBase<OrderCustomerEntity>
    {
        private readonly IOrderCustomerRepository _repository;
        private readonly ILogger<OrderCustomerController> _logger;
        ...
        public OrderCustomerController(ILogger<OrderCustomerController> logger, IOrderCustomerRepository repository,
