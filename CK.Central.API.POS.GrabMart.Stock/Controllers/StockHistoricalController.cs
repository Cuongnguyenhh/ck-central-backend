...
namespace CK.Central.API.POS.GrabMart.Stock.Controllers
{
    ...
    public class StockHistoricalController : ControllerEntityBase<StockHistoricalEntity>
    {
        private readonly IStockHistoricalRepository _repository;
        private readonly ILogger<StockHistoricalController> _logger;
        ...
        public StockHistoricalController(ILogger<StockHistoricalController> logger, IStockHistoricalRepository repository,
