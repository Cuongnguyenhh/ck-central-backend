...
namespace CK.Central.API.POS.GrabMart.Stock.Controllers
{
    ...
    public class StockActivityController : ControllerEntityBase<StockActivityEntity>
    {
        private readonly IStockActivityRepository _repository;
        private readonly ILogger<StockActivityController> _logger;
        ...
        public StockActivityController(ILogger<StockActivityController> logger, IStockActivityRepository repository,
