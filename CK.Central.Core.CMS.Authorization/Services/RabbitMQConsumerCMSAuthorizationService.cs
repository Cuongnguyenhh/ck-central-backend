...
{
    public class RabbitMQConsumerCMSAuthorizationService : RabbitMQConsumerBaseService, IRabbitMQConsumerCMSAuthorizationService
    {
        private readonly IRabbitMQBaseService _rabbitMQBaseService;

        public RabbitMQConsumerCMSAuthorizationService(IRabbitMQBaseService rabbitMqService) : base(rabbitMqService)
        {
