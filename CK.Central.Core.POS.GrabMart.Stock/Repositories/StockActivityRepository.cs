...
{
    public class StockActivityRepository : BaseRepository<StockActivityEntity>, IStockActivityRepository
    {
        ...
        public StockActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
