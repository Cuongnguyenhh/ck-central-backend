...
{
    public class StockHistoricalRepository : BaseRepository<StockHistoricalEntity>, IStockHistoricalRepository
    {
        ...
        public StockHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
