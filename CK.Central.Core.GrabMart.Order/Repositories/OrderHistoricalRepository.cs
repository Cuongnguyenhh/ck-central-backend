...
{
    public class OrderHistoricalRepository : BaseRepository<OrderHistoricalEntity>, IOrderHistoricalRepository
    {
        ...
        public OrderHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
