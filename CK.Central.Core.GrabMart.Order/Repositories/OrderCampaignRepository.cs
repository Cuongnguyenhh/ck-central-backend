...
{
    public class OrderCampaignRepository : BaseRepository<OrderCampaignEntity>, IOrderCampaignRepository
    {
        ...
        public OrderCampaignRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
