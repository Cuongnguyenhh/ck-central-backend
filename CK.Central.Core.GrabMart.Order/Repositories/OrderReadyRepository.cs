...
{
    public class OrderReadyRepository : BaseRepository<OrderReadyEntity>, IOrderReadyRepository
    {
        ...
        public OrderReadyRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
