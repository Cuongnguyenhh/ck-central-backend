...
{
    public class OrderCampaignItemRepository : BaseRepository<OrderCampaignItemEntity>, IOrderCampaignItemRepository
    {
        ...
        public OrderCampaignItemRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
