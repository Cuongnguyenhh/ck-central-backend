...
{
    public class OrderItemModifierRepository : BaseRepository<OrderItemModifierEntity>, IOrderItemModifierRepository
    {
        ...
        public OrderItemModifierRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
