...
{
    public class OrderPromotionRepository : BaseRepository<OrderPromotionEntity>, IOrderPromotionRepository
    {
        ...
        public OrderPromotionRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
