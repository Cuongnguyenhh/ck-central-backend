...
{
    public class OrderReadyEstimationRepository : BaseRepository<OrderReadyEstimationEntity>, IOrderReadyEstimationRepository
    {
        ...
        public OrderReadyEstimationRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
