...
{
    public class OrderStateRepository : BaseRepository<OrderStateEntity>, IOrderStateRepository
    {
        ...
        public OrderStateRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
