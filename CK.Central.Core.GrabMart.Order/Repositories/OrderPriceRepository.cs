...
{
    public class OrderPriceRepository : BaseRepository<OrderPriceEntity>, IOrderPriceRepository
    {
        ...
        public OrderPriceRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
