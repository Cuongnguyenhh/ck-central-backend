...
{
    public class OrderReceiverRepository : BaseRepository<OrderReceiverEntity>, IOrderReceiverRepository
    {
        ...
        public OrderReceiverRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
