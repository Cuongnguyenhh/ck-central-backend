...
{
    public class OrderCancelableRepository : BaseRepository<OrderCancelableEntity>, IOrderCancelableRepository
    {
        ...
        public OrderCancelableRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
