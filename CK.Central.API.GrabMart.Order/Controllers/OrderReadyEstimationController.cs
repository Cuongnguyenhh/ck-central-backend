...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderReadyEstimationController : ControllerEntityBase<OrderReadyEstimationEntity>
    {
        private readonly IMediator _mediator;
        private readonly IOrderReadyEstimationRepository _repository;
        private readonly ILogger<OrderReadyEstimationController> _logger;
        ...
        public OrderReadyEstimationController(IMediator mediator,
            ILogger<OrderReadyEstimationController> logger, 
            IOrderReadyEstimationRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<UpdateNewReadyTimeResponseDto>> UpdateNewReadyTimeAsync([FromBody] UpdateOrderReadyTimeCommand command)
        {
            try
            {
