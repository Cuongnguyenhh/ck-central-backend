...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderReceiverController : ControllerEntityBase<OrderReceiverEntity>
    {
        private readonly IOrderReceiverRepository _repository;
        private readonly ILogger<OrderReceiverController> _logger;
        ...
        public OrderReceiverController(ILogger<OrderReceiverController> logger, 
            IOrderReceiverRepository repository,
