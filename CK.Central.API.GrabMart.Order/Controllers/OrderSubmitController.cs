...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderSubmitController : ControllerEntityBase<OrderSubmitEntity>
    {
        ...
        public OrderSubmitController(IMediator mediator,
            ILogger<OrderSubmitController> logger,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<OrderSubmitResponseDto>> OrderSubmitAsync([FromBody] SubmitOrdersCommand command)
        {
            try
            {
