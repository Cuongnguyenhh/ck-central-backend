...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderListController : ControllerEntityBase<OrderListEntity>
    {
        ...
        public OrderListController(IMediator mediator,
            ILogger<OrderListController> logger, 
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<ListOrdersResponseDto>> ListOrdersAsync([FromBody] ListOrdersCommand command)
        {
            try
            {
