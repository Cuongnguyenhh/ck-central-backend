...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderHistoricalController : ControllerEntityBase<OrderHistoricalEntity>
    {
        private readonly IOrderHistoricalRepository _repository;
        private readonly ILogger<OrderHistoricalController> _logger;
        ...
        public OrderHistoricalController(ILogger<OrderHistoricalController> logger, IOrderHistoricalRepository repository,
