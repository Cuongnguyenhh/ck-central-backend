...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderReadyController : ControllerEntityBase<OrderReadyEntity>
    {
        private readonly IMediator _mediator;
        private readonly IOrderReadyRepository _repository;
        private readonly ILogger<OrderReadyController> _logger;
        ...
        public OrderReadyController(IMediator mediator,
            ILogger<OrderReadyController> logger, 
            IOrderReadyRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<MarkOrderAsReadyResponseDto>> MarkOrderAsReadyAsync([FromBody] MarkOrdersReadyCommand command)
        {
            try
            {
