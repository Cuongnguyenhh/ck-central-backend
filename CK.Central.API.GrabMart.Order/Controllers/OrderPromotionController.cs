...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderPromotionController : ControllerEntityBase<OrderPromotionEntity>
    {
        private readonly IOrderPromotionRepository _repository;
        ...
        public OrderPromotionController(ILogger<OrderPromotionController> logger, 
            IOrderPromotionRepository repository,
