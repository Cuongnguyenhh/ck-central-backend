...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderPriceController : ControllerEntityBase<OrderPriceEntity>
    {
        private readonly IOrderPriceRepository _repository;
        private readonly ILogger<OrderPriceController> _logger;
        ...
        public OrderPriceController(ILogger<OrderPriceController> logger, IOrderPriceRepository repository,
