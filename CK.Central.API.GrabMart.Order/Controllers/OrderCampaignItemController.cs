...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderCampaignItemController : ControllerEntityBase<OrderCampaignItemEntity>
    {
        private readonly IOrderCampaignItemRepository _repository;
        private readonly ILogger<OrderCampaignItemController> _logger;
        ...
        public OrderCampaignItemController(ILogger<OrderCampaignItemController> logger, 
            IOrderCampaignItemRepository repository,
