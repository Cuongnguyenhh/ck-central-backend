...
namespace CK.Central.API.GrabMart.Order.Controllers
{
    ...
    public class OrderItemModifierController : ControllerEntityBase<OrderItemModifierEntity>
    {
        private readonly IOrderItemModifierRepository _repository;
        private readonly ILogger<OrderItemModifierController> _logger;
        ...
        public OrderItemModifierController(ILogger<OrderItemModifierController> logger, IOrderItemModifierRepository repository,
