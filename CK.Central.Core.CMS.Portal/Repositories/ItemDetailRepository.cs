...
{
    public class ItemDetailRepository : BaseRepository<ItemDetailEntity>, IItemDetailRepository
    {
        ...
        public ItemDetailRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
