...
{
    public class ItemDisclaimerRepository : BaseRepository<ItemDisclaimerEntity>, IItemDisclaimerRepository
    {
        ...
        public ItemDisclaimerRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
