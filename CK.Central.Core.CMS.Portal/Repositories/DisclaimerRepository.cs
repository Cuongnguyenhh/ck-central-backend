...
{
    public class DisclaimerRepository : BaseRepository<DisclaimerEntity>, IDisclaimerRepository
    {
        ...
        public DisclaimerRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
