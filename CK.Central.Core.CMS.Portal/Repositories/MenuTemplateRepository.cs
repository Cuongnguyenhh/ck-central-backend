...
{
    public class MenuTemplateRepository : BaseRepository<MenuTemplateEntity>, IMenuTemplateRepository
    {
        ...
        public MenuTemplateRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
