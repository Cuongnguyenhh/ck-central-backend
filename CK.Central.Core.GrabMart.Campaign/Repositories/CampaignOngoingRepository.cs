...
{
    public class CampaignOngoingRepository : BaseRepository<CampaignOngoingEntity>, ICampaignOngoingRepository
    {
        ...
        public CampaignOngoingRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
