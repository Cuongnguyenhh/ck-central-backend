...
{
    public class CampaignUpcomingRepository : BaseRepository<CampaignUpcomingEntity>, ICampaignUpcomingRepository
    {
        ...
        public CampaignUpcomingRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
