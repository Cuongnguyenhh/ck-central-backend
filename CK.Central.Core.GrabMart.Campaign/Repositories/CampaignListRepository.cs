...
{
    public class CampaignListRepository : BaseRepository<CampaignListEntity>, ICampaignListRepository
    {
        ...
        public CampaignListRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
