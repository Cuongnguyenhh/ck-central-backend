...
namespace CK.Central.API.GrabMart.Store.Controllers
{
    ...
    public class StoreHoursController : ControllerEntityBase<StoreHoursEntity>
    {
        private readonly IMediator _mediator;
        private readonly IStoreHoursRepository _repository;
        private readonly ILogger<StoreHoursController> _logger;
        ...
        public StoreHoursController(IMediator mediator,
            ILogger<StoreHoursController> logger, 
            IStoreHoursRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<GetStoreHoursResponseDto>> CheckHoursStoreAsync([FromBody] CheckHoursStoreCommand command)
        {
            try
            {
