...
namespace CK.Central.API.GrabMart.Store.Controllers
{
    ...
    public class StoreActivityController : ControllerEntityBase<StoreActivityEntity>
    {
        private readonly IStoreActivityRepository _repository;
        private readonly ILogger<StoreActivityController> _logger;
        ...
        public StoreActivityController(ILogger<StoreActivityController> logger, IStoreActivityRepository repository,
