...
namespace CK.Central.API.GrabMart.Store.Controllers
{
    ...
    public class StoreSpecialHoursController : ControllerEntityBase<StoreSpecialHoursEntity>
    {
        private readonly IMediator _mediator;
        private readonly IStoreSpecialHoursRepository _repository;
        private readonly ILogger<StoreSpecialHoursController> _logger;
        ...
        public StoreSpecialHoursController(IMediator mediator,
            ILogger<StoreSpecialHoursController> logger, 
            IStoreSpecialHoursRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<UpdateSpecialHoursResponseDto>> UpdateSpecialHoursAsync([FromBody] UpdateStoreSpecialHoursCommand command)
        {
            try
            {
