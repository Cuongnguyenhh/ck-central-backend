...
namespace CK.Central.API.GrabMart.Store.Controllers
{
    ...
    public class StorePauseController : ControllerEntityBase<StorePauseEntity>
    {
        private readonly IMediator _mediator;
        private readonly IStorePauseRepository _repository;
        private readonly ILogger<StorePauseController> _logger;
        ...
        public StorePauseController(IMediator mediator,
            ILogger<StorePauseController> logger,
            IStorePauseRepository repository,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<TemporarilyPauseStoreResponseDto>> CheckHoursStoreAsync([FromBody] PauseUnPauseStoreCommand command)
        {
            try
            {
