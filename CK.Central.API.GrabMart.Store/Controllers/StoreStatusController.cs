...
namespace CK.Central.API.GrabMart.Store.Controllers
{
    ...
    public class StoreStatusController : ControllerEntityBase<StoreStatusEntity>
    {
        ...
        public StoreStatusController(IMediator mediator,
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<GetStoreStatusResponseDto>> CheckStatusStoreAsync([FromBody] CheckStatusStoreCommand command)
        {
            try
            {
