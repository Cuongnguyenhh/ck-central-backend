...
{
    public class StorePauseRepository : BaseRepository<StorePauseEntity>, IStorePauseRepository
    {
        ...
        public StorePauseRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
