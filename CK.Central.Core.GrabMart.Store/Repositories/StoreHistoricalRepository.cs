...
{
    public class StoreHistoricalRepository : BaseRepository<StoreHistoricalEntity>, IStoreHistoricalRepository
    {
        ...
        public StoreHistoricalRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
