...
{
    public class StoreActivityRepository : BaseRepository<StoreActivityEntity>, IStoreActivityRepository
    {
        ...
        public StoreActivityRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
