...
{
    public class StoreSpecialHoursRepository : BaseRepository<StoreSpecialHoursEntity>, IStoreSpecialHoursRepository
    {
        ...
        public StoreSpecialHoursRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
