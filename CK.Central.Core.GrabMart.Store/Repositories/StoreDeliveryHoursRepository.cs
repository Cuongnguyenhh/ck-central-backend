...
namespace CK.Central.Core.GrabMart.Store.Repositories
{
    public class StoreDeliveryHoursRepository : BaseRepository<StoreDeliveryHoursEntity>, IStoreDeliveryHoursRepository
    {
        ...
        public StoreDeliveryHoursRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
