...
{
    public class StoreHoursRepository : BaseRepository<StoreHoursEntity>, IStoreHoursRepository
    {
        ...
        public StoreHoursRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
