...
{
    public class StoreStatusRepository : BaseRepository<StoreStatusEntity>, IStoreStatusRepository
    {
        ...
        public StoreStatusRepository(IUnitOfWork context, MasterDbContext masterContext, SlaveDbContext slaveDbContext,
